...
public class Locations {
    public static double[] standardToChina(Context context, Double x, Double y) {
        try {
            InputStream in3 = context.getResources().openRawResource(R.raw.axisoffset);
            ModifyOffset mo3 = ModifyOffset.getInstance(in3);
            PointDouble pointDouble = new PointDouble(x, y);
            PointDouble s2c3 = mo3.s2c(pointDouble);
            ...
            Log.e("WZK", "Locsation standardToChina catch" + e.toString());
        }
        return null;
